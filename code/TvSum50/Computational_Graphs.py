import numpy as np
from keras.layers import BatchNormalization, Dense, Conv3D, Conv2D, Dropout, MaxPooling3D, Flatten, Activation, Input, Reshape, Conv3DTranspose, LSTM, GRU, UpSampling3D
...
#                        bias_initializer='he_normal'))
    ...
    def Conv_3D_AE(self, training_X):
        ...
        ae.fit(training_X, training_X, batch_size=2, epochs=2)
    ...
    def simple_Convolutional_AutoEncoder(self, training_X):
        ...
        kernel_size = 3
        strides = 1
        input_shape = (5, training_X.shape[2], training_X.shape[3], 3)
