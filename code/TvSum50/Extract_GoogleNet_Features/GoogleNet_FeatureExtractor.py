import numpy as np
from GoogleNet_v4 import GoogleNet_v4
from keras import backend as K
import cv2


# Read Videos and extract indivdual frames to process


# Load model

def readVideos(fileName):
    feature_matrix = np.zeros([1536])
    ...
    while (fc < frameCount and ret):
        ...
        feature_vector = googleNet.infer_layer(image)
...
googleNet = GoogleNet_v4()
feature_matrix = readVideos('../../Webscope_I4/ydata-tvsum50-v1_1/video/EE-bNr36nyA.mp4')